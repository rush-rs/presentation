\documentclass[ngerman, table, 9pt, aspectratio=169]{beamer}
\usetheme{metropolis}
...
\newcommand{\encircle}[1]{\raisebox{.5pt}{\textcircled{\raisebox{-.4pt} {\footnotesize#1}}}}
\newcommand{\TODO}[1]{\textcolor{red}{\textbf{TODO: #1}}}
\newcommand{\rushCommit}{\ignorespaces\texttt{\input "|git -C ./deps/rush rev-parse --short HEAD"}\unskip}
\newcommand{\rushCountCommits}{\ignorespaces\texttt{\input "|git -C ./deps/rush rev-list --all --count"}\unskip}
