	...
	\begin{figure}[h]
		\begin{adjustbox}{max totalsize={\textwidth}{!},center}
			\begin{tikzpicture}[node distance=1cm, inner sep=3mm]
				...
				\node (asm) [entity, fill=gray!15, right=of highlevel, align=center] {Assembly\\Ebene};
...
\begin{frame}{Stacklayouts}
	\begin{minipage}{0.45\textwidth}
		...
		\begin{tikzpicture}[xscale=0.7, yscale=0.6]
            ...
            \small
            \draw (0,\value{cellnb}-2)  node(currentcell) {\Large \riscv{}};
		\end{tikzpicture}
	\end{minipage}
	\hfill
	\begin{minipage}{0.45\textwidth}
		...
		\begin{tikzpicture}[xscale=0.7, yscale=0.6]
            ...
            \small
            \draw (0,\value{cellnb}-2)  node(currentcell) {\Large x64};
		\end{tikzpicture}
	\end{minipage}
\end{frame}
