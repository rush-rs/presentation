...
\begin{frame}{Einstieg \& Motivation}
	\pdfpcnote{
		@Mik \\
		\\
		- Softwareentwickler schreiben Programme in speziellen Sprachen \\
...
\begin{frame}{Methoden zur Programmausführung}
	\pdfpcnote{
		@Mik \\
		\\
		- Man unterscheidet zwischen 2 verschiedenen Vorgehensweisen, und zwar \\
		\\
		--- \\
		\\
		- Interpreter \\
...
\begin{frame}{Interpreter}
	\pdfpcnote{
		...
		--- \\
		\\\
		- In diesem Beispiel: Eine Ausgabe wird generiert \\
		\\
		--- \\
		\\
...
\begin{frame}{Vorgehensweise}
	\pdfpcnote{
		...
		- Jeder von uns: **einen Interpreter** und **zwei Compiler** \\
	}
	\begin{itemize}
		\item Entwicklung einer eigenen Programmiersprache
		\item Jeder hat jeweils \cemph{einen Interpreter} und \cemph{zwei Compiler} entwickelt
	\end{itemize}
\end{frame}
...
\begin{frame}{Fähigkeiten von rush}
	...
	\begin{table}[h]
		...
		\begin{tabular}{p{5.2cm}|p{5.2cm}}
			...
			Pointer                        & \Verb[commandchars=\\\{\}]{\textcolor[HTML]{a626a4}{let} \textcolor[HTML]{383a42}{b} \textcolor[HTML]{383a42}{=} \textcolor[HTML]{383a42}{&}\textcolor[HTML]{383a42}{a}\textcolor[HTML]{818387}{;} \textcolor[HTML]{383a42}{*}\textcolor[HTML]{383a42}{b}} \pause               \\
...
\begin{frame}{Datentypen in rush}
	\pdfpcnote{
		...
		--- \\
		\\
		- anzumerken: **keine** Sequenzen wie z.B. Strings \\
	}
