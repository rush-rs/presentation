...
\begin{frame}{Compiler}
	...
	\Larrow{
		...
		\end{minipage}
		\begin{minipage}{5mm}
			\includegraphics[width=5mm]{assets/google_icon_settings.png}
		\end{minipage}
	}
	\hfill
	\begin{minipage}{.35\textwidth}
...
\begin{frame}{Stufen der Übersetzung~\scite[S.~6--7]{wirth_compiler_construction_2005}}
	...
	\begin{figure}[h]
		\begin{adjustbox}{max totalsize={\textwidth}{!},center}
			...
			\end{tikzpicture}
		\end{adjustbox}
		\caption{Stufen der Übersetzung.}\label{fig:compilation_steps}
	\end{figure}
	\vfill
	\begin{figure}[h]
		\begin{adjustbox}{max totalsize={\textwidth}{!},center}
			...
			\end{tikzpicture}
		\end{adjustbox}
		\caption{Stufen der Übersetzung (angepasst).}\label{fig:compilation_steps_altered}
	\end{figure}
	\vfill
\end{frame}
