...
\begin{frame}{Vorgehensweise}
	\pdfpcnote{
		@Mik \\
		\\
		- Um diese Fragestellung zu untersuchen sind Wir wie folgt vorgegangen: \\
		- Wir haben eine eigene Programmiersprache entwickelt \\
		- Jeder von uns hat jeweils einen Interpreter und zwei Compiler fuer unsere Sprache entwickelt \\
	}
	\begin{itemize}
		\item Entwicklung einer eigenen Programmiersprache
		\item Jeder hat \cemph{einen Interpreter} und \cemph{zwei Compiler} entwickelt
	\end{itemize}
\end{frame}
