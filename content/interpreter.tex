...
\begin{frame}{Tree-Walking Interpreter}
	\begin{itemize}
		\item Traversiert den Syntaxbaum
...
\begin{frame}{Weitere Typdefinitionen}
	\begin{minipage}{0.6\textwidth}
		\Lirsting[float=H, ranges={6-13, 22-28}]{deps/rush/crates/rush-interpreter-tree/src/value.rs}
	\end{minipage}
	\hfill
...
\begin{frame}{Traversierung}
	\begin{figure}[H]
        ...
        Syntaxbaum zu \enquote{\LirstInline{rush}{1 + 2 * 3}}
	\end{figure}
\end{frame}
